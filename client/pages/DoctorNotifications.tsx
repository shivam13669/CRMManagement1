        ...
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
          <div>
            ...
            <p className="text-gray-600 mt-2">
              Stay updated with patient appointments, messages, and important updates
            </p>
          </div>
        ...
        <Tabs defaultValue="all" className="space-y-6">
          <TabsList>
            ...
            <TabsTrigger value="patient">
              Patients ({notifications.filter(n => n.type === 'patient').length})
            </TabsTrigger>
          ...
          {['all', 'appointment', 'patient', 'report', 'message'].map((tabType) => (
