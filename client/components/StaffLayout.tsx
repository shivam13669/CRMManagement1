...
const sidebarItems = [
  ...
  { icon: Truck, label: 'Ambulance Management', path: '/staff-ambulance-management' },
...
export function StaffLayout({ children }: StaffLayoutProps) {
  ...
  useEffect(() => {
    ...
    const handleStorageUpdate = () => {
      const count = parseInt(localStorage.getItem('staffNotificationCount') || '0');
      setFeedbackNotificationCount(count);
    };

    // Listen for custom events from StaffFeedback component
    window.addEventListener('staffNotificationsUpdated', handleFeedbackNotifications as EventListener);
    ...
    return () => {
      window.removeEventListener('staffNotificationsUpdated', handleFeedbackNotifications as EventListener);
                  ...
                  <>
                    ...
                    <div className="absolute right-0 mt-2 w-80 bg-white rounded-lg shadow-lg border border-gray-200 z-50 max-h-96 overflow-hidden">
                      ...
                      <div className="max-h-80 overflow-y-auto">
                        ...
                        ) : (notifications.length === 0 && feedbackNotificationCount === 0) ? (
                          <div className="px-4 py-8 text-center text-gray-500">
                                ...
                                <div className="flex items-start space-x-3">
                                  ...
                                  <div className="flex-1 min-w-0">
                                    ...
                                    <p className="text-sm text-gray-600 mt-1">
                                      {feedbackNotificationCount > 5 ? '5+' : feedbackNotificationCount} new feedback/complaint{feedbackNotificationCount > 1 ? 's' : ''} received
                                    </p>
              ...
              <div className="relative">
                ...
                {profileDropdownOpen && (
                  <>
                    ...
                    <Link to="/staff-profile" className="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100">
                      My Profile
                    </Link>
